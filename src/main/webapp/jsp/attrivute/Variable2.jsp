...
session.setAttribute("page2 session variable","page2 session value");
application.setAttribute("page2 application variable","page2 application value");

out.print("page2 pageContext variable:" + pageContext.getAttribute("page2 pageContext variable") + "<br/>"
		...
		+ "page2 application variable:" + application.getAttribute("page2 application variable")+ "<br/>");
